...
void LCD_Tripeangle(u16 x1, u16 y1, u16 x2, u16 y2,u8 flag)
{
	if(y1==y2)
	{
		if(flag==0)
...
void Mouse_Ground(void)
{
	POINT_COLOR=BLACK;
	LCD_DrawRectangle(20,40,70,90);//(1,1)
	LCD_Fill(20,40,70,90,BLACK);
	POINT_COLOR=BLACK;
	LCD_DrawRectangle(90,40,140,90);//(1,2)
	LCD_Fill(90,40,140,90,BLACK);
	POINT_COLOR=BLACK;
	LCD_DrawRectangle(160,40,210,90);//(1,3)
	LCD_Fill(160,40,210,90,BLACK);
	POINT_COLOR=BLACK;
	LCD_DrawRectangle(20,100,70,150);//(2,1)
	LCD_Fill(20,100,70,150,BLACK);
	POINT_COLOR=BLACK;
	LCD_DrawRectangle(90,100,140,150);//(2,2)
	LCD_Fill(90,100,140,150,BLACK);
	POINT_COLOR=BLACK;
	LCD_DrawRectangle(160,100,210,150);//(2,3)
	LCD_Fill(160,100,210,150,BLACK);
	POINT_COLOR=BLACK;
	LCD_DrawRectangle(20,160,70,210);//(3,1)
	LCD_Fill(20,160,70,210,BLACK);
	POINT_COLOR=BLACK;
	LCD_DrawRectangle(90,160,140,210);//(3,2)
	LCD_Fill(90,160,140,210,BLACK);
	POINT_COLOR=BLACK;
	LCD_DrawRectangle(160,160,210,210);//(3,3)
	LCD_Fill(160,160,210,210,BLACK);
	LCD_Draw_Circle(10,65,4);
	LCD_Draw_Circle(80,65,4);
	LCD_Draw_Circle(150,65,4);
	LCD_Draw_Circle(10,125,4);
	LCD_Draw_Circle(80,125,4);
	POINT_COLOR=RED;
	LCD_Draw_Circle(80,125,2);
	POINT_COLOR=BLACK;
	LCD_Draw_Circle(150,125,4);
	LCD_Draw_Circle(10,185,4);
	LCD_Draw_Circle(80,185,4);
	LCD_Draw_Circle(150,185,4);
	POINT_COLOR=RED;
	LCD_ShowString(0,5,200,16,16,"score:");	
}
